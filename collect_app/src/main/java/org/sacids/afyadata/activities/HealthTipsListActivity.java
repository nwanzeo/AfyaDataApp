...
public class HealthTipsListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Activity Title
        setTitle(getString(R.string.app_name) + " > " + getString(R.string.nav_item_tips));
        ...
        if (diseaseList.size() > 0) {
            ...
            Toast.makeText(context, getString(R.string.no_content), Toast.LENGTH_LONG).show();
        }
    ...
    private void refreshDisplay() {
        diseaseAdapter = new DiseaseListAdapter(this, diseaseList);
    ...
    class FetchTipsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String tipsURL = serverUrl + "/api/v3/ohkr/get_diseases";
