...
public class SurveyForm implements Parcelable {
    ...
    public String getJrInstanceId() {
        return jrInstanceId;
    }

    public void setJrInstanceId(String jrInstanceId) {
        this.jrInstanceId = jrInstanceId;
    }
